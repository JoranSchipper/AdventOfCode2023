...
let mappedList = list.map((item) => {
    ...
    return `${numbersInString[0]}${numbersInString[numbersInString.length - 1]}`;
});

// sum the values of the array
let sum = mappedList.reduce((accumulator, currentValue) => Number(accumulator) + Number(currentValue), 0);
